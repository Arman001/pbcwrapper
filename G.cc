...
void G::pow2(G &gout, const G &base1, const Zr &exp1, const G &base2, const Zr &exp2){
  if(elementPresent && base1.isElementPresent() && base2.isElementPresent() && exp1.isElementPresent() && exp2.isElementPresent()){
...
void G::pow3(G &gout, const G &base1, const Zr &exp1, const G &base2, const Zr &exp2, const G &base3, const Zr &exp3){
  if(elementPresent && base1.isElementPresent() && base2.isElementPresent() && base3.isElementPresent() && exp1.isElementPresent() && exp2.isElementPresent() && exp3.isElementPresent()){
        element_pow3_zn(*(element_t*)&gout.getElement(), *(element_t*)&base1.getElement(), *(element_t*)&exp1.getElement(), *(element_t*)&base2.getElement(), *(element_t*)&exp2.getElement(), *(element_t*)&base3.getElement(), *(element_t*$
  }else throw UndefinedElementException();
}
